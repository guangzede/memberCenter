    ...
    <div class="sibling">
      ...
      <div class="app-container shadow">
        <div class="content">
          ...
          <div class="flex-buttons">
            ...
            <el-button type="primary" @click="initParam(1),init()">查询</el-button>
          </div>
            ...
            <el-row :gutter="20">
              ...
              <el-col :md="12" :lg="8" >
                <el-form-item label="事件名称" >
                  <el-input v-model="searchForm.name" maxlength="30" clearable placeholder="请输入事件名称"/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
      ...
      <div class="app-container shadow">
        <div class="content">
          ...
          <div class="flex-buttons">
            <el-button @click="linkTo('/scene/growthmedia/add')">新增事件信息</el-button>
          </div>
          <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column label="操作" width="190px">
              <template slot-scope="scope">
                ...
                <el-divider direction="vertical"/>
                <el-popconfirm title="点击确定后将启用本条应用" @onConfirm="updataScene(scope.row,'0')">
                  <el-button slot="reference" :disabled="scope.row.startFlag=='0'" type="text" >启用</el-button>
                </el-popconfirm>
                <el-divider direction="vertical"/>
                <el-popconfirm title="点击确定后将禁用本条应用" @onConfirm="updataScene(scope.row,'1')">
...
export default {
  ...
  methods: {
    ...
    clickDetail(path, row, data) {
      ...
      this.$router.push(`/scene/growthmedia/${path}`)
    },
